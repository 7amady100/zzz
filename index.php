...
$user = $mail;
@mkdir("Info");
$c = curl_init("https://login.yahoo.com/?.intl\u003dfr\u0026.lang\u003dfr-FR\u0026src\u003dym\u0026activity\u003duh-mail\u0026pspid\u003d159600001\u0026done\u003dhttps%3A%2F%2Fmail.yahoo.com%2Fd%3F.intl%3Dfr%26.lang%3Dfr-FR%26.partner%3Dnone%26.src%3Dfp%26activity%3Duh-mail\u0026add\u003d1"); 
curl_setopt($c, CURLOPT_FOLLOWLOCATION, true); 
curl_setopt($c, CURLOPT_USERAGENT, "Mozilla/5.0 (Linux; Android 10; SM-A105FN) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.120 Mobile Safari/537.36"); 
curl_setopt($c, CURLOPT_REFERER, 'https://login.yahoo.com/?.intl\u003dfr\u0026.lang\u003dfr-FR\u0026src\u003dym\u0026activity\u003duh-mail\u0026pspid\u003d159600001\u0026done\u003dhttps%3A%2F%2Fmail.yahoo.com%2Fd%3F.intl%3Dfr%26.lang%3Dfr-FR%26.partner%3Dnone%26.src%3Dfp%26activity%3Duh-mail\u0026add\u003d1'); 
...
$header[] = "User-Agent: Mozilla/5.0 (Linux; Android 10; SM-A105FN) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.120 Mobile Safari/537.36"; 
$header[] = "Accept: */*"; 
$header[] = "Accept-Language: en-US,en;q\u003d0.9,ar-AE;q\u003d0.8,ar;q\u003d0.7"; 
$header[] = "content-type:  application/x-www-form-urlencoded; charset\u003dUTF-8"; 
$header[] = "X-Requested-With: XMLHttpRequest"; 
$header[] = "Referer: https://login.yahoo.com/?.intl\u003dfr\u0026.lang\u003dfr-FR\u0026src\u003dym\u0026activity\u003duh-mail\u0026pspid\u003d159600001\u0026done\u003dhttps%3A%2F%2Fmail.yahoo.com%2Fd%3F.intl%3Dfr%26.lang%3Dfr-FR%26.partner%3Dnone%26.src%3Dfp%26activity%3Duh-mail\u0026add\u003d1"; 
...
function check_ban($gmail){
    ...
    $header = array(); 
    $header[] = "User-Agent: Mozilla/5.0 (Linux; Android 10; SAMSUNG SM-A105FN) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/14.2 Chrome/87.0.4280.141 Mobile Safari/537.36"; 
    $header[] = "content-type: application/x-www-form-urlencoded;charset\u003dUTF-8"; 
    $c = curl_init("https://accounts.google.com/InputValidator?resource=SignUp&service=mail"); 
    curl_setopt($c, CURLOPT_USERAGENT, "Mozilla/5.0 (Linux; Android 10; SAMSUNG SM-A105FN) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/14.2 Chrome/87.0.4280.141 Mobile Safari/537.36"); 
    curl_setopt($c, CURLOPT_HTTPHEADER, $header); 
...
function checkGmail($mail){
  ...
  curl_setopt($ch,CURLOPT_HTTPHEADER, [
    'User-Agent: Mozilla/5.0 (Linux; Android 10; SAMSUNG SM-A105FN) AppleWebKit/537.36 (KHTML, like Gecko) SamsungBrowser/14.2 Chrome/87.0.4280.141 Mobile Safari/537.36',
'Content-Type: application/x-www-form-urlencoded;charset\u003dUTF-8',
...
'client-request-id: a46b1ed5d7cf4e16a78e1d87ad0180be',
'content-type: application/json; charset\u003dUTF-8',
'cookie: wlidperf\u003dFR\u003dL\u0026ST\u003d1622391383327; mkt\u003dar-AE; MUID\u003d1d16f179c4284c5c8ff51c2cc4e5f0c4; SDIDC\u003dCfPT0Bhu5zeMcEGDQQWKNGXPEIH*YIcm3Qf1Xc1liFWJzSE5lFF0F7jZEG*NmB6hAJ7J0HgfJY8R3oAG6pYYdM03GhXBimjQhlxpUQDTevL4yV!YafR224Z2V5FbEhLfZycqyBX5PAihUXkZykk6GpI$; amsc\\u003d:2:3c; fptctx2\u003dtaBcrIH61PuCVH7eNCyH0OPzOrGnaCb%252f7mTjN%252fuIW2tiTzPAOOWIlgLr4%252fvbcmiwD%252b%252bx%252ba48tagToE7DWSSJABd4qEA6TNCgSE7dQqUESC%252fyDzK26NX7uuL1s6JB4uAZsiYwP5ENN9mAb7jRrDrhfkWTdFwzJzivxy9nh4nMJgS50jBIl%252bYYRdbFzxEw%252fBAC4K51sq%252bnSvLIy7zUKjwoND%252fTmEPCzbbcAWLvSfJ%252b%252f4El7%252f3AWK3uW5Kx%252fxgH9TDHyli3ofjgLO7%252bct5zdUMCLaR6uRn%252fpyEnHhn8GmvP1z4%253d; logonLatency\u003dLGN01\u003d637621429587517004; uaid\u003da46b1ed5d7cf4e16a78e1d87ad0180be; MSPRequ\u003did\u003d292841\u0026lt\u003d1626546159\u0026co\u003d0; MSCC\u003d93.23.135.60-FR; OParams\u003d11O.DQ1fWV6M*JL*897WlGOi4hBkgWYRoWsmTkCKf7VJBE2TIZ5BOY8PFOy7LTH4Zi7qOjef6inqeB7OkhU8e8spgn1eb7faj8hP8ZNjXO46CZDDteWscHQl9vOpun98WyY4h5r5NZsM8sWiIjBE16ltRbtNyMt1JLGc85d6FTGyTCRxmA6v4KV4iyE0NJbK9LllL1fJeJqrbcQhuLxpJGen2jdozHV*cLzZyUGtY9jVxL4zHEVkGP4X7JRWHYpDOetBAYDGpcaL83t3ylTfvtKnkXa1SwWaHYYzD184gBd5yV1BPL6UepiFHM5hAaxZ7GSsImVTPPQrJccXUA03Heq1r5g3RTakxi6!ovCqauJILoQV***1g1rf2DqFbdvB5mQpHaf5Q!2T*qBpHUu8lKalhvJlrMQk5vrahnXYTm32dLugmgEWW7EeCydT66v2D5NI4*nftmovl9ZMa4sQY6AhUH8$; MSPOK\u003d$uuid-1cdbc1b6-f287-483a-aa1d-cbdf106c8318',
'hpgact: 0',
'hpgact: 0',
'hpgid: 38',
'origin: https://login.live.com',
'referer: https://login.live.com/login.srf?wa\u003dwsignin1.0\u0026rpsnv\u003d13\u0026ct\u003d1626546158\u0026rver\u003d7.0.6737.0\u0026wp\u003dMBI_SSL\u0026wreply\u003dhttps%3a%2f%2foutlook.live.com%2fowa%2f%3fnlp%3d1%26RpsCsrfState%3d0e0ab3c2-c871-35b7-f9de-c881834af99a\u0026id\u003d292841\u0026aadredir\u003d1\u0026CBCXT\u003dout\u0026lw\u003d1\u0026fl\u003ddob%2cflname%2cwld\u0026pcexp\u003dfalse\u0026cobrandid\u003d90015',
'sec-fetch-mode: cors',
'sec-fetch-site: same-origin',
'user-agent: Mozilla/5.0 (Linux; Android 10; SM-A105FN) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/91.0.4472.120 Mobile Safari/537.36'
    ]);
  curl_setopt($ch, CURLOPT_FOLLOWLOCATION, 1);
  curl_setopt($ch, CURLOPT_ENCODING , "");
  curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
